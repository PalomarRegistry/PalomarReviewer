...
validates the returned JSON schema. The CLI owns rubric prompts and
orchestration and checks every returned pass with the credential-output
backstop before that pass can enter another prompt or leave the review
workspace.
